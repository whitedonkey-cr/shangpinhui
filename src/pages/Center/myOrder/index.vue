        ...
        <div class="order-content">
            ...
            <div class="orders">
                <table class="order-item" v-for="(order, index) in myorder.records" :key="order.id">
                    ...
                    <tbody>
                        <tr v-for="(items, index) in order.orderDetailList" :key="items.id">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="items.imgUrl" style="width:100px; height: 100px;">
                                    <a href="#" class="block-text">{{ items.skuName }}</a>
                                    <span>x{{ items.skuNum }}</span>
